...
class ChatRoomViewController:UIViewController {
    ...
    private let accessoryHeight: CGFloat = 120
    ...
    private var safeAreaBottom: CGFloat {
        ...
        get {self.view.safeAreaInsets.bottom}
    ...
    private func setupChatRoomTableView() {
        ...
        chatRoomTableView.backgroundColor = .gray
    ...
    private func fetchMessages() {
        ...
        guard  let  chatroomDocId = chatroom?.documentId else { print("65")
            return}
